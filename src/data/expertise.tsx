export const deepExpertise = [
  {
    id: 'ai',
    area: 'AI & Technology',
    level: 'Expert',
    links: [
      { label: 'Get Coaching', url: '/coaching/apply?topic=ai', external: false },
    ],
    icon: (
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Get Coaching', url: '/coaching/apply?topic=hubspot', external: false },
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: 'George is not just certified, he has been shaping the HubSpot conversation for over a decade. His deep understanding of the platform spans marketing, sales, service, and operations hubs.',
  },
  {
    id: 'marketing',
    ...
    level: 'Expert',
    links: [
      { label: 'Get Coaching', url: '/coaching/apply?topic=marketing', external: false },
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    level: 'World-Class',
    links: [
      { label: 'Get Coaching', url: '/coaching/apply?topic=video', external: false },
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    level: 'World-Class',
    links: [
      { label: 'Get Coaching', url: '/coaching/apply?topic=podcasting', external: false },
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    level: 'Expert',
    links: [
      { label: 'Get Coaching', url: '/coaching/apply?topic=personal', external: false },
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    level: 'Expert',
    links: [
      { label: 'Get Coaching', url: '/coaching/apply?topic=leadership', external: false },
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const broadCompetencies = [
  {
...
export const principles = [
  ...
  {
    title: 'AI Assisted',
    description: 'Leveraging cutting edge AI tools to amplify productivity, creativity, and reach.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="4" y="4" width="16" height="16" rx="2" ry="2"/>
        <rect x="9" y="9" width="6" height="6"/>
