...
const packageInfo = {
  activation: {
    ...
    nextSteps: [
      ...
      'Jot down your top 3 questions or challenges, and we\'ll tackle them together',
      'Find a quiet spot for our video call',
      'Come ready to dream big. I\'ll help you get specific',
    ],
    resources: [
      { title: 'Beyond Your Default Podcast', url: 'https://beyondyourdefault.com', description: 'Get inspired while you wait with episodes on personal transformation' },
  ...
  growth: {
    ...
    nextSteps: [
      ...
      'Join our private community where you\'ll connect with fellow growth-seekers',
  ...
  transformation: {
    ...
    nextSteps: [
      ...
      'Join our private community where you\'ve got VIP access',
