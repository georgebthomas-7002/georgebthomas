...
const podcastEpisodes: PodcastEpisode[] = [
  {
    id: '1',
    showName: 'Mick Unplugged',
    episodeTitle: 'Digital Marketing Mastery',
    description: 'A deep dive into digital marketing strategies, personal branding, and the mindset shifts needed to thrive in today\'s digital landscape.',
    platform: 'apple',
    listenUrl: 'https://podcasts.apple.com/us/podcast/bonus-episode-5-george-b-thomas-digital-marketing-mastery/id1731755953?i=1000653332527',
    image: '/images/mick-unplugged.jpg',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    platform: 'web',
    listenUrl: 'https://engagevideomarketing.com/podcasts/how-to-use-personalised-video-to-grow-your-business-with-george-b-thomas/',
  ...
  },
  {
    ...
    platform: 'apple',
    listenUrl: 'https://podcasts.apple.com/us/podcast/digital-transformation-and-human-connections-george-b/id1725743945?i=1000641760412',
    ...
    <>
      ...
      <main id="main-content">
        ...
        <section id="contact" className="section cta-section-light">
          <div className="container container--narrow">
            <AnimatedSection className="cta-block cta-block--light cta-block--personality" animation="fade-in">
              <Image
                src="/images/george-headshot.jpg"
                alt="George B. Thomas"
                width={80}
                height={80}
                className="cta-block__avatar"
              />
              <h2 className="cta-block__title">Let&apos;s Make It Happen</h2>
              <p className="cta-block__description">
                Your listeners deserve real stories, actionable insights, and an energy that keeps them engaged. Let&apos;s create that together.
              </p>
              <div className="cta-block__response-badge">
              ...
              <div className="cta-block__buttons cta-block__buttons--hierarchy">
                <Link href="/book" className="btn btn--primary btn--xl">
                  Book a Call
                </Link>
                <div className="cta-block__secondary-buttons">
                  <a
